...
const newBooks =  books.filter((book) => { if(book.sales > 1000000){
    return book;
}})
const greatAuthors = newBooks.map(({author, title}) => {return `${author} adalah penulis buku ${title} yang sangat hebat!`});
